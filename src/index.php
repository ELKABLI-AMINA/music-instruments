         ...
         <form id="signin" action="" method="POST" class=" bg-white col-lg-5  mb-lg-0 position-relative  p-4">
            <div class="row mb-3 ">
               ...
               <div class="">
                  ...
                  " class="form-control" name="emailaddressi" onkeyup="validate_email()" id="emailaddressi">
            ...
            <div class="row mb-3">
               <div class="">
                  <input type="password" value="<?php if (isset($_COOKIE['password'])) {echo $_COOKIE['password'];} ?>" class="form-control" name="passwordi" onkeyup="validate_pw()" id="passwordi">
